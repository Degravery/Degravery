...
$sql =  "SELECT * FROM test1_questions ORDER BY RAND()";
$i=0;
...
<div class="alertcontain">
    <div class="alertheadercontain"><div class="alertheader"><a>Suitable College: CCIS</a></div></div>
    <div class="alerttextcontain"><div class="alerttext"><a>Collage of Computing and Information Sciences (CCIS) is a college or academic division that focuses on computer programming related courses like Computer Science and Information Technology.</a></div></div>
    ...
    <form action="calculating.php?token1" method="post">
